...
```js
{
  ...
  workspaceID:       "wrk_<your-workspace-id>",
  ...
  keyID:             "key_<your-key-id>",
  sessionID:         "ses_<example-session-id-1>", // opencode session ID, direct join key
...
|----------------------------------------------|---------------|----------------|-----------|
| `~/src/bamboo/acme/widgets/BAM-123`              | AcmeCorp           | Widgets           | `BAM-123` |
| `~/src/bamboo/acme/gadgets/BAM-124`         | AcmeCorp           | Gadgets      | `BAM-124` |
...
|----------|----------------------------------------------|------------------|
| `ses_A1` | `~/src/bamboo/acme/widgets/BAM-123`              | claude-opus-4-7  |
| `ses_A2` | `~/src/bamboo/acme/widgets/BAM-123`              | gpt-5-nano       |
| `ses_B1` | `~/src/bamboo/acme/gadgets/BAM-124`         | claude-opus-4-7  |
| `ses_B2` | `~/src/bamboo/acme/gadgets/BAM-124`         | claude-opus-4-7  |
...
|---------------------|---------------------|-----------------|----------|
| AcmeCorp                 | Gadgets           | claude-opus-4-7 | $5.00    |
| AcmeCorp                 | Widgets                | claude-opus-4-7 | $5.00    |
...
| AcmeCorp                 | Widgets                | gpt-5-nano      | $0.10    |

Sum of `cost_usd` column == `$16.10`.

AcmeCorp / Gadgets aggregates `ses_B1` ($3.00) + `ses_B2` ($2.00) — the
...
|---------------------|---------------------|---------------------|-----------------|----------|
| AcmeCorp                 | Gadgets           | BAM-124             | claude-opus-4-7 | $5.00    |
| AcmeCorp                 | Widgets                | BAM-123             | claude-opus-4-7 | $5.00    |
...
| AcmeCorp                 | Widgets                | BAM-123             | gpt-5-nano      | $0.10    |
...
- `ses_<example-session-id-1>`
- `ses_<example-session-id-2>`
- `ses_<example-session-id-3>`
