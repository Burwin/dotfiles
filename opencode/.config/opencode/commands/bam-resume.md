...
The trigger from §3 names a **model tier** (e.g. `cheap` / `premium`, per `@rules/plans.md`). Compare that named tier against the model **this** session is actually running on:
